...
public class LoginServlet extends HttpServlet
{
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException
	{
		...
		builder.append("휴대전화: ").append(user_hp).append("<br>");
		
		user_address = URLEncoder.encode(user_address, StandardCharsets.UTF_8);
		
		builder.append("<a href='/pro09/second?user_id=").append(user_id).append("&user_pw=").append(user_pw).append("&user_address=").append(user_address).append("'>두 번째 서블릿으로 보내기</a>");
